...
MODEL_PATH = os.path.join('models', 'fgsm_fashion_mnist')
TARGETED = True
NOISE_OUTPUT = False


def fashion_mnist_tutorial_fgsm(train_start=0, train_end=60000, test_start=0,
  ...
  """
  Fashion MNIST tutorial for Fast Gradient Method's attack
  ...
  if viz_enabled:
    ...
    if noise_output:
      image_name = "output/fgsm_fashion_mnist_noise.png"
    else:
      image_name = "output/fgsm_fashion_mnist.png"
...
def main(argv=None):
  ...
  fashion_mnist_tutorial_fgsm(viz_enabled=FLAGS.viz_enabled,

...
BATCH_SIZE = 128
LEARNING_RATE = .001
MODEL_PATH = os.path.join('models', 'jsma_fashion_mnist')
SOURCE_SAMPLES = 50
NOISE_OUTPUT = True


def fashion_tutorial_jsma(train_start=0, train_end=60000, test_start=0,
  ...
  sample_all = np.zeros((nb_classes, img_rows, img_cols, nchannels), dtype='f')
  ...
  print('Avg. rate of perturbed features for successful '
    ...
    # Compute the average distortion introduced by the algorithm
  l2_norm = np.mean(np.sum((adv_all - sample_all)**2,
                                     axis=(1, 2, 3))**.5)
...
def main(argv=None):
  ...
  fashion_tutorial_jsma(viz_enabled=FLAGS.viz_enabled,

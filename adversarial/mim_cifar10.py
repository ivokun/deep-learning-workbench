...
MODEL_PATH = os.path.join('models', 'mim_cifar10')
TARGETED = True
NOISE_OUTPUT = True

def cifar10_tutorial_mim(train_start=0, train_end=60000, test_start=0,
  ...
  """
  CIFAR10 tutorial for Momentum Iterative Method's attack
  ...
  if viz_enabled:
    if noise_output:
      image_name = "output/mim_cifar10_noise.png"
    else:
      image_name = "output/mim_cifar10.png"
...
def main(argv=None):
  ...
  cifar10_tutorial_mim(viz_enabled=FLAGS.viz_enabled,

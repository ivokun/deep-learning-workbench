...
BATCH_SIZE = 128
LEARNING_RATE = .001
MODEL_PATH = os.path.join('models', 'jsma_cifar10')
SOURCE_SAMPLES = 50
NOISE_OUTPUT = True


def cifar10_tutorial_jsma(train_start=0, train_end=60000, test_start=0,
...
def main(argv=None):
  ...
  cifar10_tutorial_jsma(viz_enabled=FLAGS.viz_enabled,

...
using MIM attack in white-box setting.
"""
...
MODEL_PATH = os.path.join('models', 'mim_fashion_mnist')
TARGETED = True
NOISE_OUTPUT = True


def fashion_mnist_tutorial_mim(train_start=0, train_end=60000, test_start=0,
  ...
  """
  Fashion MNIST tutorial for Momentum Iterative Method's attack
  ...
  if viz_enabled:
    if noise_output:
      image_name = "output/mim_fashion_mnist_noise.png"
    else:
      image_name = "output/mim_fashion_mnist.png"
...
def main(argv=None):
  ...
  fashion_mnist_tutorial_mim(viz_enabled=FLAGS.viz_enabled,
